...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			//  VS Matt
			case 'matt':
				tex = Paths.getSparrowAtlas('vsmatt/matt_assets');
				frames = tex;
			...
			case 'mattmad':
				tex = Paths.getSparrowAtlas('vsmatt/mattmad');
				frames = tex;
				animation.addByPrefix('idle', 'matt idle', 24, false);
				animation.addByPrefix('singUP', 'matt up note', 24, false);
				animation.addByPrefix('singDOWN', 'matt down note', 24, false);
			...
			case 'bf-wii':
				var tex = Paths.getSparrowAtlas('vsmatt/bf-wii', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			// x event
			case 'xchara':
				tex = Paths.getSparrowAtlas('x-event/xchara');
				frames = tex;
			...
			case 'ink':
				tex = Paths.getSparrowAtlas('x-event/ink');
				frames = tex;
				animation.addByPrefix('idle', 'Ink idle dance', 24, false);
			...
			// smoke
			case 'garcello':
				tex = Paths.getSparrowAtlas('smoke/garcello_assets');
				frames = tex;
				...
				playAnim('idle');
			case 'garcellotired':
				tex = Paths.getSparrowAtlas('smoke/garcellotired_assets');
				frames = tex;
